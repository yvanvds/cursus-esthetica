...
- **Het courante leenwoord is de juiste term, niet de terugvaloptie.** Zegt het vakgebied *piece*, *tag*, *still*, *sample*, *frame* of *mixen*, dan schrijf je dat — ook als er een Nederlands alternatief bestaat. De vraag is nooit "kan dit in het Nederlands", maar "wat zegt iemand die hier verstand van heeft". Gebruikersfeedback (aug 2026): het graffitihoofdstuk had "spuitbuskunst" staan, een woord dat niemand gebruikt. Zulke woorden ontstaan door eerst per se een Nederlandse term te willen en er desnoods zelf een te bouwen. Dat is de verkeerde volgorde.
- **Verzin geen Nederlandse samenstellingen.** Vóór je een samengesteld vakwoord neerzet dat je nergens hebt gezien: check of die term zo voorkomt in een Nederlandstalig handboek, glossarium of museumtekst. Vind je hem niet, dan is dat geen uitnodiging om er zelf een te maken — dan gebruik je het leenwoord.
- **De omgekeerde toets: purismelijsten als bewijs van gangbaarheid.** Twijfel je of een leenwoord mag blijven staan, kijk dan of een taalpuristische vervangingslijst het wil vervangen — de [Bond tegen Leenwoorden](https://www.bondtegenleenwoorden.nl/) is de bruikbaarste, want die gaat het verst (*salade* → koumoes, *sculptuur* → beeldhouwkunst, *sonnet* → klinkdicht, en ook Franse en Latijnse leenwoorden). Staat een woord daar, dan is het per definitie gangbaar: niemand voert campagne tegen een woord dat niemand gebruikt. Dat beslist de vraag "mag het blijven" met ja.
  Wat de toets *niet* beslist: of het Nederlandse alternatief ook goed is. Naast *sculptuur* is "beeldhouwwerk" volstrekt normaal; kies dan op ritme en context. En de lijst dekt algemene woordenschat, geen vakjargon — voor *wildstyle*, *throw-up* of *chronofotografie* geldt gewoon wat het vakgebied zegt.
- **Cursiveer een courant leenwoord niet.** Cursief betekent "dit woord is vreemd". Dat klopt voor een term die je op dat moment invoert of die in het Nederlands echt ongebruikelijk is (*pixação*, *Gesamtkunstwerk*), en niet voor woorden die allang meedraaien: piece, tag, still, sample, remix. Bij twijfel rechtop.
- **Uitzondering: de gevestigde Nederlandse vakterm wint wél.** Gebruikt het vakgebied zelf een Nederlandse term, dan is dat de goede — een *suspension* heet in Nederlandstalige muziekbronnen consequent **vertraging**, *ground bass* heet **vaste basfiguur** of **bas-ostinato**. Dit botst niet met de regels hierboven: het gaat steeds om wat de gangbare term is, niet om welke taal die toevallig heeft.
...
- [ ] **Leenwoord-check.** Loop de vaktermen in het hoofdstuk langs. Staat er een zelfgemaakte samenstelling waar het vakgebied een leenwoord gebruikt? Wordt een standaardterm omschreven in plaats van gebruikt? Staat een courant leenwoord cursief alsof het vreemd is? Alle drie zijn fouten.
